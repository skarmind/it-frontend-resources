...
> Для переключения цветовых схем необходимо установить атрибуту color-scheme коренвого элемента html значение dark или light. Это автоматически изменит значения CSS переменных соответственно их цветовой схеме.
